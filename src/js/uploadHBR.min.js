...
var uploadHBR = function () {
    ...
    function makeHTML($index) {
        ...
        return "<div class=\"box-drag column\" draggable=\"true\"><input type=\"hidden\" name=\""+ postName + "[]\" id=\"base64_" + $index + "\" data-id=\"" + $index + "\"><div class=\"form-group\"><div class=\"col-12 no-padding uploadArea\" data-index=\"" + $index + "\"><span class=\"new\" id=\"new_" + $index + "\" title=\"" + textTitle + "\" data-index=\"" + $index + "\"><input type=\"file\" class=\"fileHidden d-none\" multiple=\"\" accept=\"" + $mimes + "\" id=\"hidden_" + $index + "\" data-index=\"" + $index + "\"><i class=\"" + iconNew + "\"></i><p>" + textNew + "</p></span><span class=\"image-preview d-none\" id=\"prev_" + $index + "\"><div class=\"remove\" title=\"" + textTitleRemove + "\" data-index=\"" + $index + "\"><i class=\"" + iconClose + "\"></i></div><img class=\"img-fluid\" src=\"\"></span></div></div></div>";
    }
